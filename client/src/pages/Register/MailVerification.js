                ...
                >
                    ...
                    <Container>
                        ...
                        <div className="motto text-center " >
                            <img style={{
                                width: "60px", height: "60px", marginBottom: "0px"
                            }}
                                alt="..."
                            ...
                            <h4 className="title">You can now sign in with your new account</h4>
                            <br />

                            <Button className="btn-round  " onClick={handleClick} color="neutral" type="button" outline>
                                Log In
                            </Button>
                        </div>
                    </Container>
                        ...
                        <Container className="text-center">
                            ...
                            <Row>
                                <Col className="ml-auto mr-auto text-center" md="8">
                                    <h2 className="title text-danger">Your email is not verified!</h2>
                                    <p className="note">
                                        We have sent you the verification mail.
                                ...
                                <Col className="ml-auto mr-auto download-area" md="5">
                                    <Button
                                        className="btn-round"
                                        onClick={() => { setAlert(true); setisHiddesn(true) }}
                                        hidden={isHiddesn}
                                        color="danger"
                            ...
                            <Row>
                                <Col >
                                    {showAlert ? (
                                        ...
                                        <Alert  color="info">
                                            <Container>
                                                <span>We have sent you the verification mail please verify.</span>
                                            </Container>
                                        </Alert>
                                    ) : (
                                        <p></p>
