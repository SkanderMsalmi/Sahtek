      ...
      <div className="col-md-6">
        <div className="card" style={{ height: "100%" }}>
          <div className={`${styles.contactInfo} card-body`}>
            ...
            <h5>Working hours</h5>
            <div className="row">
              <div className="col-md-6">Monday-Friday</div>
              <div className="col-md-6">9:00 AM - 5:00 PM</div>
            </div>
            <div className="row">
              <div className="col-md-6">Saturday</div>
              <div className="col-md-6">9:00 AM - 1:00 PM</div>
            </div>
            <div className="row">
              <div className="col-md-6">Sunday</div>
              <div className="col-md-6">Closed</div>
            </div>
            <br />
            <div
              style={{
          ...
          <div className="row">
            ...
            <div className={`${styles.contactInfo} col-md-6`}>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditInfo({ ...editInfo, license: e.target.value })
                }
              />
            </div>
          </div>
